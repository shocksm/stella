...
public class DeleteDialog extends BaseInsertUpdateDialog implements ModifyListener
{
  ...
  public DeleteDialog(Shell parent, TableInfo tableInfo, SessionData sessionData)
  {
    super(parent, tableInfo, sessionData);

    super.init(false, false, true);

    setText("Create delete statment for " + this.tableInfo.getName());
  ...
  protected void createControls(boolean editable, boolean forceChecks, boolean hasWhere)
  {
    ...
    label.setText("rows will be deleted");
  ...
  private void updateCount()
  {
    ...
    WorkerRunnable worker = new WorkerRunnable()
    {
      ...
      public void doTask()
      {
        ...
        try
        {
          Connection con = DeleteDialog.this.sessionData.getConnectionManager().getConnection();
        ...
        finally
        {
          ...
          DeleteDialog.this.sessionData.getConnectionManager().releaseConnection();
        }
      }
  ...
  public static void main(String[] args)
  {
    ...
    DeleteDialog id = new DeleteDialog(shell, tableInfo, null);
    id.open();
