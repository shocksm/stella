...
public class CustomTable<T> extends Composite implements KeyListener, MouseListener, MouseMoveListener, SelectionListener, MenuListener, PaintListener {
	...
	public void widgetSelected(SelectionEvent e) {
		if (e.widget == copyCellMI) {
			...
			final T selectedRowObject = rowObject;
	...
	/**
	 * call after the table is displayed so SWT can calc with width correctly
	 */
	...
	public static void main(String[] args) {
		...
		CustomTable<Object[]> test = new CustomTable<Object[]>(shell);
